...
public class Card2 extends javax.swing.JPanel {
    ...
    protected void paintChildren(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(0,0,Color.decode("#ad5389"),0,getHeight(),Color.decode("#3c1053"));
        g2d.setPaint(gp);
    ...
    public void setTotal(){
        String sql = "SELECT SUM(consumption) FROM Customer";
        try{
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(287, 153));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/water.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Water Distributed");
